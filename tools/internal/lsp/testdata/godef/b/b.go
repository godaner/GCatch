...
import (
	myFoo "github.com/godaner/GCatch/tools/internal/lsp/foo" //@godef("foo", PackageFoo),godef("myFoo", PackageFoo)
	"github.com/godaner/GCatch/tools/internal/lsp/godef/a"   //@mark(AImport, "\"")
)
